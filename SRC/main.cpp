...
uint256 hashGenesisBlock("0x7dee29c0ed0ff123f255f315bda754ca94233ecad72c2f09f7b911b7a97bf518");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // TraderCoin: starting difficulty is 1 / 2^12
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // TraderCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1457715846, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Lets go 03 november";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0497567c992caa02f3ba619efb44277326f4657e02e12547ed1f4e924157db4663dced85281300fdbfbac64795cf534578b59cf89ca867817377822caa20a16f78") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1457715846;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1692431;
        ...
        assert(block.hashMerkleRoot == uint256("0xa6a4e8abae372ef7b2c311388be73009898df6114cdc3eecfa8f471c65ee487b"));
...
unsigned char pchMessageStart[4] = { 0x85, 0xf9, 0xc3, 0x5d }; // TraderCoin: increase each by adding 2 to bitcoin's value.
